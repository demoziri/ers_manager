										...
										<div class="card card-outline">
												<div class="card-body box-profile">
														<div class="text-center">
																<img class="profile-user-img img-fluid img-circle" onclick="location.href='/ers/lsupporter/nowreportList'"
				src="/resources/lsupporter/img/당일보고서.png" style="width: 600px; height: 400px;" alt=""
								>
						</div>
						<h3 class="profile-username text-center">당일 보고서내역</h3>
				</div>
