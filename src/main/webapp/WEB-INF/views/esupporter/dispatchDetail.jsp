		...
		<div class="row">
			<div class="col-12">
				<div class="buttons mb-1">
					...
					<button type="button" class="btn bg-green" onclick="reportyModify();">보고서 수정</button>
					<button type="button" class="btn btn-primary" onclick="reportRegist();">보고서 등록</button>
				</div>
			</div>
		</div>
...
<script>
	var sCode = $('#sCode').val();
	function reportyModify() {
		location.href = "reportModify?afterUrl=1&sCode="+sCode;
	}
	
	function reportRegist() {
		location.href = "reportForm?afterUrl=1&sCode="+sCode;
	}
</script>
