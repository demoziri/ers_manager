...
<body class="total">
										...
										<table class="board-table">
												...
												<tbody>
														<tr>
																...
																<th class="tah-title"><input type="text" class="titles"></th>
														</tr>
														...
														<tr>
																...
																<th class="tah-content"><textarea class="summernote" id="summernote" name="content"></textarea></th>

														</tr>
														<tr>
																<td class="tad-attach">첨부파일</td>

																<th class="tah-attach"><input type="file" class="files"></th>
														</tr>
												</tbody>
										</table>
								</div>
		...
		<div class="wrap">
				<section>
						<button class="update" type="button" id="confirm">등록하기</button>
